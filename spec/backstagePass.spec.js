...
describe("Backstage Pass", () => {
  it("quality increased by 2", () => {
    const backstagePass = new Item("Backstage passes to a TAFKAL80ETC concert", 10, 5)
  ...
  it("quality increased by 2", () => {
    const backstagePass = new Item("Backstage passes to a TAFKAL80ETC concert", 5, 5)
    const items = [backstagePass]
    const shop = new Shop(items)
    shop.updateBackstagePass(backstagePass)
   ...
   it("quality increased by 2", () => {
    const backstagePass = new Item("Backstage passes to a TAFKAL80ETC concert", 0, 5)
    const items = [backstagePass]
    const shop = new Shop(items)
    shop.updateBackstagePass(backstagePass)
